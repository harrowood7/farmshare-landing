{/* Move LogoBanner.tsx content here */}
import React from 'react';
import { CUSTOMER_LOGOS } from '../../constants';
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <p className="text-lg text-stone-600 font-medium">Trusted by leading processors across the country</p>
        </div>
