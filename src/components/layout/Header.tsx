      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/producers" className={getLinkClass('/producers')}>
              Producers
            </Link>
            <Link to="/buyers" className={getLinkClass('/buyers')}>
              Meat Buyers
            </Link>
        ...
        <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
          <nav className="mt-4 space-y-4 pb-4">
            ...
            <Link 
              to="/producers" 
              className={`block ${getLinkClass('/producers')}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Producers
            </Link>
            <Link 
              to="/buyers" 
              className={`block ${getLinkClass('/buyers')}`}
              onClick={() => setIsMenuOpen(false)}
            >
              Meat Buyers
            </Link>
