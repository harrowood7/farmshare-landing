  ...
  const features = {
    ...
    management: {
      ...
      bullets: [
        ...
        'QuickBooks Integration: Sync all billing and payment data to reduce double entry'
      ],
  ...
  return (
    <div className="min-h-screen bg-brand-cream">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center fade-up">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-stone-600 mb-6 lg:mb-8 font-medium stagger-child">
              Farmshare helps you run a tighter plant with auto-scheduling, live tracking, and simplified communications—all from one dashboard.
            </p>
            <a 
              href="https://meetings.hubspot.com/henry-arrowood/quad-p-demo"
              target="_blank"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-brand-cream rounded-lg p-8 transform hover:-translate-y-2 transition-transform duration-300 fade-up">
              ...
              <p className="text-stone-700">Farmshare combines your calendar, cut cards, spreadsheets, text/email tools, payment processing, and QuickBooks syncing—all in a single platform.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-brand-cream p-6 rounded-lg shadow-lg fade-up">
              ...
              <div className="flex items-center">
                ...
                />
                <div>
                  <p className="font-bold text-brand-green">Robert Thompson</p>
                  <p className="text-stone-600">Prairie Valley Meats</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto text-center fade-up">
          <h2 className="text-2xl md:text-3xl font-roca text-brand-orange mb-4 md:mb-6 stagger-child">Ready to Transform Your Processing Business?</h2>
          <p className="text-base md:text-xl text-stone-700 mb-6 md:mb-8 stagger-child">
            Join the growing network of processors who are revolutionizing their operations with Farmshare. Let's discuss how we can help you boost efficiency and increase profits.
          </p>
          <a 
            href="https://meetings.hubspot.com/henry-arrowood/quad-p-demo"
            target="_blank"
